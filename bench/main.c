...
void update_table_bench (bench_count n)
{
	...
	double * a = ent_column_ref (ent_table_add_column (table, "a", "float64"));
	double * b = ent_column_ref (ent_table_add_column (table, "b", "float64"));
	double * c = ent_column_ref (ent_table_add_column (table, "c", "float64"));
